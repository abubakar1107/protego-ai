  ...
  return (
    <section className="px-6 py-24 bg-seer-surface">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-8 md:p-12 rounded-2xl bg-seer-indigo text-white flex flex-col justify-between min-h-[300px]">
           <div>
        ...
        <div className="grid grid-cols-1 gap-6">
           <div className="p-8 rounded-2xl bg-white border border-seer-border shadow-sm flex flex-col justify-center h-full">
              <span className="text-seer-indigo text-5xl font-serif mb-2">~$400B</span>
              <span className="text-seer-muted text-lg">US Legal Services Market</span>
           </div>
           <div className="p-8 rounded-2xl bg-white border border-seer-border shadow-sm flex flex-col justify-center h-full">
              <p className="text-sm font-mono text-seer-indigo uppercase tracking-widest mb-3">Jurisdiction Coverage</p>
